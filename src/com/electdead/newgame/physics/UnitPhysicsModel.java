...
public class UnitPhysicsModel {
    ...
    //TODO test random speed
    public float getDefaultSpeed() {
        return defaultSpeed + (float) (Math.random() * defaultSpeed / 5);
    }
    ...
    public void setDefaultSpeed(float defaultSpeed) {
        this.defaultSpeed = defaultSpeed / EngineV2.UPDATES_PER_SEC;
    }
    ...
    public void setAttackSpeed(float attackSpeed) {
        this.attackSpeed = attackSpeed / EngineV2.MS_PER_UPDATE;
    }
